...
/**
 *
 * this user profile is based on aws s3 server, since i'm poor,
 * so i no longer had s3 server, those code will not be used.
 *
 * refer to user profile function, go to userProfile2.js
 *
 */
